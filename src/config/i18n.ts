...
const resources = {
  ...
  saving: "Salvando...",
      ...
      no_attachments: "Não há arquivos anexados",
    ...
    new_service_order: {
      ...
      preview_not_supported_local: "Pré-visualização não disponível para arquivos Office locais. O arquivo será baixado.",
      ...
      no_operations: "Nenhum registro efetuado até o momento",
      operation_details: "Detalhes da operação",
      collapse_all: "Fechar todos",
      expand_all: "Expandir todos",
      no_matching_operations: "Nenhuma operação encontrada para a busca",
      match: "Encontrado"
    },
    goods_service_order: {
      ...
      call_sign: "Número de chamada",
      mmsi_number: "Número MMSI",
      port_of_registry: "Porto de registro",
      flag_state: "País de bandeira",
      loa: "LOA",
      breadth: "Bredth",
      depth: "Depth",
      gross_tonnage: "Tonelagem bruta",
      net_tonnage: "Tonelagem líquida",
      owner: "Proprietário",
      ...
      flat_racks_and_position_on_board: "Flat racks e posição a bordo",
      ...
      vessel_berthed: "Data de atracação do navio",
      operations_commenced: "Data de início das operações",
      surveyor_at_terminal: "Data de chegada do inspetor ao terminal",
      surveyor_on_board: "Data de embarque do inspetor",
      unlashing: "Data de início do destombamento",
      lifting_1: "Data de início da primeira içada",
      lifting_2: "Data de início da segunda içada",
      lifting_3: "Data de início da terceira içada",
      lifting_4: "Data de início da quarta içada",
      lifting_5: "Data de início da quinta içada",
      discharge_completed: "Data de conclusão do desembarque",
      final_inspection: "Data da inspeção final",
      surveyor_left_terminal: "Data de saída do inspetor do terminal",
      delete_record_confirmation: "Deseja realmente excluir o registro?",
    ...
    tallies_service_order: {
      ...
      first_site_inspection: "Primeiro local de inspeção",
      second_site_inspection: "Segundo local de inspeção",
    },
    users: {
      users: "Usuários",
      company: "Empresa",
  ...
  es: {
      tally: {
        ...
        latitude: "Latitud",
        longitude: "Longitud",
        delete_record_confirmation: "¿Desea eliminar el registro?",
        search_plate: "Buscar matrícula",
        search_plate_placeholder: "Escriba la matrícula...",
      },
    errors: {
    ...
    common: {
      ...
      file_downloaded: "Archivo bajado con éxito!",
